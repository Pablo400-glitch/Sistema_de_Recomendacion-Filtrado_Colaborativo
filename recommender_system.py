...
def display_help():
    ...
    print(colored("4. número_vecinos: El número de vecinos a considerar en el cálculo de las recomendaciones.\n", "blue"))
...
if __name__ == '__main__':
  ...
  if num_neighbours >= len(data):
      print(colored("\nError: El número de vecinos debe ser menor que la cantidad de datos.\n", "red"))
      sys.exit(1)
